function Isosurfaces( volume, isovalue, screen )
{
    ...
    function interpolated_vertex( v0, v1, s )
    {
        ...
        let iv0 = v0.x + v0.y*lines + v0.z*slices;
        let iv1 = v1.x + v1.y*lines + v1.z*slices;
        let sc0 = volume.values[ iv0 ][0];
        let sc1 = volume.values[ iv1 ][0];
        let ce0 = (sc1 - s)/(sc1 - sc0);
        let ce1 = (s - sc0)/(sc1 - sc0);
        return new THREE.Vector3().addVectors( v0.multiplyScalar(ce0), v1.multiplyScalar(ce1) );
    }
}
